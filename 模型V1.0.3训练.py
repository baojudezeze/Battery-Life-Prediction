...
if __name__ == "__main__":
    ...
    # y更换为循环寿命而不是SOH
    with open("./Data/cyclelife1.csv", "r") as f:
    ...
    # 暂时取前3个数据集的数据
    VIT5, IR, CT, QD3, WSD_IC, WSD_QV50, PICC = VIT5[:140], IR[:140], CT[:140], QD3[:140], WSD_IC[:140], \
    ...
    mse = 0
    for i in range(16):
        mse = (y_train[i] - y_val[i]) * (y_train[i] - y_val[i]) + mse
    mse = mse / 16
